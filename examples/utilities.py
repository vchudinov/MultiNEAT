...
def plot_nn(genome,substrate, params , ax):
    ...
    for connection in nn.connections:
        ...
        offsetx =  n2[0] - start_x


        offsety = n2[1] - start_y
        ...
        if connection.weight < 0.0:
            ax.arrow(start_x, start_y, offsetx, offsety, head_width=0.01,
    ...
    for index in indices:
        ...
        if n[2] == 0:
            ...
            ax.add_patch(plt.Circle((n[0], n[1]- 0.1) , 0.03, fc='green'))
    return
...
if __name__ == "__main__":
    ...
    #      para300
    g = NEAT.Genome("genomes/best_1_5_3000")
    ...
    '''
    #fig = plt.figure(figsize = (18,6))
    ax = plt.gca()    #ax.set_title("LEO Output")
    ax.set_xlim(-1.2,1.2)
    ax.set_ylim(-1.2, 1.2)
